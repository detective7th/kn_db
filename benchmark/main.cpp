...
int main(int argc, char** argv) {
  ...
  if(std::string(argv[1]) == std::string("sl"))
  {
      ...
      release_skillist("/home/kid/workspace/kn_db/debug/data/",base, max_level, skip);
  ...
  {
      namedot::set_search_bench_single("/home/kid/SSE/kn_db/data/orders/000002");
  }
  else if(std::string(argv[1]) == std::string("transaction"))
  {
      ndt::set_search_bench_single("/home/kid/SSE/kn_db/data/transactions/000002");
  }
  else if(std::string(argv[1]) == std::string("timeshare"))
  {
      nts::set_search_bench_single("/home/kid/SSE/kn_db/data/one_min/000002");
  }
